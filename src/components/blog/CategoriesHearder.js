                                ...
                                >
                                    ...
                                    </Link>
                                    {
                                        categories&&categories.map(category => (
                                            ...
                                            className={`${location.pathname === `/${category.slug}` ? "text-indigo-500 bg-white":"text-gray-900 hover:text-indigo-500"} inline-flex flex-col text-center lg:w-auto py-2 px-6 text-gray-900 rounded-lg text-sm font-semibold`}>
                                                {category.name}
                                            </Link>
                                        ))
                                    }
