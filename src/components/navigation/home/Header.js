              ...
              <div>
                ...
                <ul className="flex gap-8 items-center justify-center py-12">
                    <li className="mt-6 text-lg font-medium leading-8 text-gray-700 sm:text-center inline-flex border-b-2 border-transparent hover:border-indigo-500 hover:text-black" >
                        <Link to='/servicios/item1'>
                            Servicio 1
                        </Link>
                    </li>
                    <li className="mt-6 text-lg font-medium leading-8 text-gray-700 sm:text-center inline-flex border-b-2 border-transparent hover:border-indigo-500 hover:text-black" >
                        <Link to='/servicios/item2'>
                            Servicio 2
                        </Link>
                    </li>
                    <li className="mt-6 text-lg font-medium leading-8 text-gray-700 sm:text-center inline-flex border-b-2 border-transparent hover:border-indigo-500 hover:text-black" >
                        <Link to='/servicios/item3'>
                            Servicio 3
                        </Link>
                    </li>
                    <li className="mt-6 text-lg font-medium leading-8 text-gray-700 sm:text-center inline-flex border-b-2 border-transparent hover:border-indigo-500 hover:text-black" >
                        <Link to='/servicios/item4'>
                            Servicio 4
                        </Link>
                    </li>
                </ul>
                ...
                <div className="mt-8 flex gap-x-4 sm:justify-center">
                  ...
                  >
                    Live demo
                    <span className="animate-ping text-gray-400" aria-hidden="true">
                      &rarr;
                    </span>
                  </a>
                </div>
